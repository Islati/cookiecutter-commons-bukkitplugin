...
class CookieCutterCommonsBukkitPlugin(TemplateRenderPlugin):
    def __init__(self):
        super(CookieCutterCommonsBukkitPlugin, self).__init__(
            name="cookiecutter_commons_bukkitplugin_template",
            template_name="Commons_BukkitPlugin", version="1",
            description="Template Render plugin used to generate a Commons-utilizing Bukkit Plugin."
        )
...
cookiecutter_commons_bukkitplugin = CookieCutterCommonsBukkitPlugin()
